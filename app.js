...
function renderSafety() {
  ...
  el.innerHTML = `
    <button class="sos-btn" style="width:100%;padding:24px;font-size:20px;font-weight:800;border-radius:var(--radius);margin-bottom:20px;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;border:none;cursor:pointer;box-shadow:0 8px 24px rgba(239,68,68,0.4);" onclick="triggerSOS()">
